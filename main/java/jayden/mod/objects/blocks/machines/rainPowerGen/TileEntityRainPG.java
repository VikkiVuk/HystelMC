...
import jayden.mod.objects.blocks.energy.CustomEnergyStorage;
...
public class TileEntityRainPG extends TileEntity implements ITickable
{
	...
	{
		return new TextComponentTranslation("container.rainpg");
	}
