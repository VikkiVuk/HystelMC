...
import jayden.mod.objects.blocks.item.ItemBlockVariant;
...
public class BlockOres extends Block implements IHasModel, IMetaName 
{
	...
	public BlockOres(String name, String dimension) {
		...
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.BLUESTONE));
	...
	public void registerModels() {
		for (int i = 0; i < EnumHandler.EnumType.values().length; i++) {
			HystelMC.proxy.registerVariantRenderer(Item.getItemFromBlock(this), 1,
