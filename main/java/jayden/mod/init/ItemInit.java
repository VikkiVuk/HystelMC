...
import jayden.mod.objects.items.Wrench;
import jayden.mod.objects.items.food.ItemCustomFood;
import jayden.mod.objects.items.food.ItemLemonSeeds;
import jayden.mod.objects.items.food.ItemTomatoSeed;
import jayden.mod.objects.items.staffs.BigFireballStaff;
...
public class ItemInit 
{
	...
	public static final ArmorMaterial ARMOUR_TRIVIA = EnumHelper.addArmorMaterial("armour_trivia", Reference.MOD_ID + ":trivia",  25, new int[]{5, 7, 6, 4}, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F);
	 ...
	 //Wrench
	 public static final Item WRENCH = new Wrench("wrench", 256);
	 
	 //Staffs
	 public static final Item LARGE_FIREBALL_STAFF = new BigFireballStaff("large_fireball_staff");
	 ...
	 public static final Item LEMON = new ItemCustomFood("lemon", 4, false);
