...
{
	private static final ResourceLocation GUI_CHEST = new ResourceLocation(Reference.MOD_ID + ":textures/gui/rainbow_chest.png");
	private final InventoryPlayer playerInventory;
	private final TileEntityRainbowChest te;
	
	public GuiRainbowChest(InventoryPlayer playerInventory, TileEntityRainbowChest chestInventory, EntityPlayer player) 
	{
		super(new ContainerRainbowChest(playerInventory, chestInventory, player));
