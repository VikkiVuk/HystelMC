...
public class MCreatorCrsGui extends Elementshm.ModElement {
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			if (ent instanceof MCreatorCrsCrafter.TileEntityCustom)
				inherited = (IInventory) ent;
			else
				inherited = new InventoryBasic("", true, 9);
			this.addSlotToContainer(new Slot(inherited, 0, 17, 21) {
			});
			this.addSlotToContainer(new Slot(inherited, 1, 17, 39) {
			});
			this.addSlotToContainer(new Slot(inherited, 2, 17, 57) {
			});
			this.addSlotToContainer(new Slot(inherited, 3, 35, 21) {
			});
			this.addSlotToContainer(new Slot(inherited, 4, 35, 39) {
			});
			this.addSlotToContainer(new Slot(inherited, 5, 35, 57) {
			});
			this.addSlotToContainer(new Slot(inherited, 6, 53, 21) {
			});
			this.addSlotToContainer(new Slot(inherited, 7, 53, 39) {
			});
			this.addSlotToContainer(new Slot(inherited, 8, 53, 57) {
			});
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			hm.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
		}
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("hm:textures/crsgui.png");
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("CRS Crafter", 7, 2, -12566464);
		}
		...
		protected void actionPerformed(GuiButton button) {
			hm.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		}
