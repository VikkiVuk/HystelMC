...
public class MCreatorDiamondGenOpnACH extends Elementshm.ModElement {
	public static final CustomAdvancementTrigger trigger = new CustomAdvancementTrigger();

	public MCreatorDiamondGenOpnACH(Elementshm instance) {
		super(instance, 13);
	}
	...
	public static class CustomAdvancementTrigger implements ICriterionTrigger {
		...
		public ResourceLocation getId() {
			return new ResourceLocation("diamondgenopnach");
		}
		...
		static class Listeners {
			...
			void triggerAdvancement(EntityPlayerMP player) {
