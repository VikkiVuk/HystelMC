...
public class MCreatorSinteringFurnaceGui extends Elementshm.ModElement {
	public static int GUIID = 2;
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;

	public MCreatorSinteringFurnaceGui(Elementshm instance) {
		super(instance, 27);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			if (ent instanceof MCreatorBloSinteringFurnace.TileEntityCustom)
				inherited = (IInventory) ent;
			else
				inherited = new InventoryBasic("", true, 9);
			this.addSlotToContainer(new Slot(inherited, 0, 26, 21) {
			});
			this.addSlotToContainer(new Slot(inherited, 1, 26, 57) {
			});
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("hm:textures/sinteringfurnacegui.png");
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Sintering Furnace", 7, 2, -12566464);
		}
