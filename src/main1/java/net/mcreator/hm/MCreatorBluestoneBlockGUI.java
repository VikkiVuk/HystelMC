...
public class MCreatorBluestoneBlockGUI extends Elementshm.ModElement {
	public static int GUIID = 1;
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;

	public MCreatorBluestoneBlockGUI(Elementshm instance) {
		super(instance, 9);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			if (ent instanceof MCreatorBluestoneblock.TileEntityCustom)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("hm:textures/bluestoneblockgui.png");
		...
		public void updateScreen() {
			super.updateScreen();
			label1.updateCursorCounter();
		}

		@Override
		protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
			label1.mouseClicked(mouseX - guiLeft, mouseY - guiTop, mouseButton);
			super.mouseClicked(mouseX, mouseY, mouseButton);
		}

		@Override
		protected void keyTyped(char typedChar, int keyCode) throws IOException {
			label1.textboxKeyTyped(typedChar, keyCode);
			if (label1.isFocused())
				return;
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 64, this.guiTop + 59, 50, 20, "Enter"));
			label1 = new GuiTextField(0, this.fontRenderer, 27, 22, 120, 20);
			guiinventory.put("text:label1", label1);
			label1.setMaxStringLength(32767);
			label1.setText("");
		}
					...
					if (buttonID == 0) {
						{
							...
							MCreatorBluestoneBlockGUIOnButtonClicked.executeProcedure($_dependencies);
						}
					}
				});
			return null;
