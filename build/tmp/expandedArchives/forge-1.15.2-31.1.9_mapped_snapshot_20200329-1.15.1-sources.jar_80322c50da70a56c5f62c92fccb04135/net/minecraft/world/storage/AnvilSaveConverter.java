...
public class AnvilSaveConverter {
   ...
   static boolean func_215792_a(Path p_215792_0_, DataFixer p_215792_1_, String p_215792_2_, IProgressUpdate p_215792_3_) {
      ...
      if (worldinfo != null && worldinfo.getGenerator() == WorldType.FLAT) {
         biomeprovider = biomeprovidertype.create(biomeprovidertype.func_226840_a_(worldinfo).setBiome(Biomes.PLAINS));
      } else {
         biomeprovider = biomeprovidertype1.create(biomeprovidertype1.func_226840_a_(worldinfo));
      }

      func_215794_a(new File(file1, "region"), list, biomeprovider, 0, i, p_215792_3_);
      func_215794_a(new File(file2, "region"), list1, biomeprovidertype.create(biomeprovidertype.func_226840_a_(worldinfo).setBiome(Biomes.NETHER)), list.size(), i, p_215792_3_);
      func_215794_a(new File(file3, "region"), list2, biomeprovidertype.create(biomeprovidertype.func_226840_a_(worldinfo).setBiome(Biomes.THE_END)), list.size() + list1.size(), i, p_215792_3_);
