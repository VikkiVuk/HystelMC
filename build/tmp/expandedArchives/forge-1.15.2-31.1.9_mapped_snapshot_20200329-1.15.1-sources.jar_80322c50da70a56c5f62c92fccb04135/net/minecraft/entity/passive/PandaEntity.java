...
public class PandaEntity extends AnimalEntity {
   ...
   private void func_213546_et() {
      ...
      if (this.func_213578_dZ()) {
         ...
         if (!this.world.isRemote && this.func_213559_es() > 80 && this.rand.nextInt(20) == 1) {
            if (this.func_213559_es() > 100 && this.isBreedingItemOrCake(this.getItemStackFromSlot(EquipmentSlotType.MAINHAND))) {
   ...
   private boolean isBreedingItemOrCake(ItemStack p_213548_1_) {
   ...
   static class AttackGoal extends MeleeAttackGoal {
      ...
      public boolean shouldExecute() {
         return this.field_220722_d.canPerformAction() && super.shouldExecute();
      }
   }
   ...
   static class AvoidGoal<T extends LivingEntity> extends AvoidEntityGoal<T> {
       ...
       */
      public boolean shouldExecute() {
         return this.field_220875_i.isWorried() && this.field_220875_i.canPerformAction() && super.shouldExecute();
      }
   }
   ...
   class SitGoal extends Goal {
       ...
       */
      public boolean shouldExecute() {
         if (this.field_220832_b <= PandaEntity.this.ticksExisted && !PandaEntity.this.isChild() && !PandaEntity.this.isInWater() && PandaEntity.this.canPerformAction() && PandaEntity.this.func_213544_dV() <= 0) {
