         ...
         if (!serverworld.isCloseToVillage(blockpos, 6)) {
            ...
            Vec3d vec3d = RandomPositionGenerator.func_221024_a(this.entity, 15, 7, (p_220734_3_) -> {
               if (!serverworld.isVillage(p_220734_3_)) {
                  ...
                  Optional<BlockPos> optional1 = serverworld.getPointOfInterestManager().find(PointOfInterestType.field_221053_a, this::func_220733_a, p_220734_3_, 10, PointOfInterestManager.Status.IS_OCCUPIED);
            ...
            if (vec3d == null) {
               ...
               Optional<BlockPos> optional = serverworld.getPointOfInterestManager().find(PointOfInterestType.field_221053_a, this::func_220733_a, new BlockPos(vec3d), 10, PointOfInterestManager.Status.IS_OCCUPIED);
